...
// let canvas2 = document.getElementById("background2");
// let c2 = canvas2.getContext("2d");

// // size of canvas2
// const imgSize2 = 512;

// canvas2.width = imgSize2;
// canvas2.height = imgSize2;

// // init image data with black pixels
// const image2 = c2.createImageData(imgSize2, imgSize2);
// for (let i = 0; i < image.data.length; i += 4) {
//     image.data[i] = 0; // R
//     image.data[i + 1] = 0; // G
//     image.data[i + 2] = 0; // B
...
// // returns the distance of point x,y from the origin 0,0
// const distance2 = (x, y) => Math.sqrt(x * x + y * y);
...
// const makeFiveColorGradient2 = (c1, c2, c3, c4, c5) => {
//     const g = [];
...
// // two palettes we interpolate between
// const palettes2 = [makeRandomPalette(), makeRandomPalette()];
...
// // stores whether we're interpolating colors
// // from palette 0 -> 1 (1) or 1 -> 0 (-1)
// let prevDirection2 = 1;

// const updatePalette2 = t => {
//     const timeScale = 0.0005;
//     const x = t * timeScale;
...
//     for (let u = 0; u < imgSize2; u++) {
//     for (let v = 0; v < imgSize2; v++) {
//         // indexes into height maps for pixel
//         const i = (u + dy1) * mapSize + (v + dx1);
//         const k = (u + dy2) * mapSize + (v + dx2);
